...
import FitnessAgeDetail from './screens/FitnessAgeDetail.jsx';
...
import PitchLog from './screens/PitchLog.jsx';
...
const routeMeta = {
  ...
  '/tracking/fitness-age': { title: 'Fitness age', topLevel: false, tab: 'health' },
  ...
  '/tracking/pitch': { title: 'Pitch session', topLevel: false, tab: 'health' },
    ...
    <div className="app">
      ...
      <ScreenContainer pathname={location.pathname}>
        <Routes>
          ...
          <Route path="/tracking/fitness-age" element={<FitnessAgeDetail />} />
          ...
          <Route path="/tracking/pitch" element={<PitchLog />} />
