...
// swim load factors now live in the SKB gymSupport (seasonVolume + systemicFactor 0.95).
const swimming = skb.get('swimming').gymSupport;
let fails = 0;
...
near(sportLoadScalar({ sport_intent: 'compete', sport_days: days(3) }, { season: 'in', gymSupport: swimming }), 0.524, 'in-season swim ×3');
// off-season build_base ×3/wk: 0.90 × 1.0 × 0.92 × 0.95 = 0.786
near(sportLoadScalar({ sport_intent: 'recreational', sport_goal: 'build_base', sport_days: days(3) }, { season: 'off', gymSupport: swimming }), 0.786, 'off build_base swim ×3');
// off get_stronger ×2/wk: 0.90 × 0.90 × 1.0 × 0.95 = 0.7695
near(sportLoadScalar({ sport_intent: 'recreational', sport_goal: 'get_stronger', sport_days: days(2) }, { season: 'off', gymSupport: swimming }), 0.7695, 'off get_stronger swim ×2');
// clamp floor: in-season swim ×5/wk would be 0.60×0.78×0.95=0.4446 → clamp 0.5
near(sportLoadScalar({ sport_intent: 'compete', sport_days: days(5) }, { season: 'in', gymSupport: swimming }), 0.5, 'floor clamps to 0.5');
