...
| [`design/engine-v2/`](design/engine-v2/README.md) | **The Decision Engine V2 blueprint set** (2026-07-14, PROPOSAL/T4): 14 deliverables — architecture, hierarchy, 17-stage pipeline, performance model, knowledge map, session builder, constraint engine, progression, explainability, AI boundaries, migration M0–M6, validation strategy. Adoption = ratification per DEVELOPMENT-PLAN §5.3 |
