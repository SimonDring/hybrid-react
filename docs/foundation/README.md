...
| **[../architecture/AIGAS.md](../architecture/AIGAS.md)** | The AI Governance & Architecture Specification (ratified 2026-07-13 — the sixth governing document, peer of the TAS). | The constitutional role of AI · the AI/engine boundary · permitted vs prohibited AI capabilities |
