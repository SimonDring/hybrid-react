...
2. **Resistance-shaped definitions in frozen text (§6, §46, §34).** Dose
   ...
   ("fractional hard sets for resistance work") are *definitions*, not examples. A future
