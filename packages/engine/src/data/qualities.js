...
// trainabilityByBand (WP-36): how responsive the quality is at each training-age band
// (data/trainingAgeBands.js) — diminishing returns for strength/size with training age
// (Rhea 2003); tissue/control/range qualities stay responsive. Consensus priors (L4),
// used by D4 as magnitude MODIFIERS, never gates.
...
export const QUALITIES = [
  { id: 'maxStrength', family: 'strength', adaptations: ['motor_unit_recruitment', 'myofibrillar_hypertrophy'],
    ...
    recoveryTimeH: 48, trainabilityByBand: { novice: 1.0, intermediate: 0.9, advanced: 0.75, highlyAdvanced: 0.6 },
    prerequisites: [], evidence: 'seed',
  ...
  { id: 'hypertrophy', family: 'structural', adaptations: ['myofibrillar_hypertrophy', 'sarcoplasmic_hypertrophy'],
    ...
    recoveryTimeH: 48, trainabilityByBand: { novice: 1.0, intermediate: 0.9, advanced: 0.8, highlyAdvanced: 0.7 },
    prerequisites: [], evidence: 'seed',
  ...
  { id: 'explosiveStrength', family: 'power', adaptations: ['rate_coding', 'motor_unit_recruitment'],
    ...
    recoveryTimeH: 48, trainabilityByBand: { novice: 0.9, intermediate: 1.0, advanced: 0.9, highlyAdvanced: 0.8 },
    prerequisites: ['maxStrength'], evidence: 'seed',
  ...
  { id: 'reactiveStrength', family: 'power', adaptations: ['tendon_stiffness', 'ssc_efficiency'],
    ...
    recoveryTimeH: 72, trainabilityByBand: { novice: 0.8, intermediate: 1.0, advanced: 0.95, highlyAdvanced: 0.85 },
    prerequisites: ['maxStrength'], evidence: 'seed',
  ...
  { id: 'strengthEndurance', family: 'endurance', adaptations: ['capillary_density', 'fiber_type_shift'],
    ...
    recoveryTimeH: 24, trainabilityByBand: { novice: 1.0, intermediate: 0.95, advanced: 0.85, highlyAdvanced: 0.8 },
    prerequisites: [], evidence: 'seed',
  ...
  { id: 'aerobicCapacity', family: 'aerobic', adaptations: ['mitochondrial_density', 'stroke_volume', 'capillary_density'],
    ...
    recoveryTimeH: 24, trainabilityByBand: { novice: 1.0, intermediate: 0.95, advanced: 0.9, highlyAdvanced: 0.85 },
    prerequisites: [], evidence: 'seed',
  ...
  { id: 'anaerobicCapacity', family: 'anaerobic', adaptations: ['glycolytic_enzymes', 'buffering_capacity'],
    ...
    recoveryTimeH: 48, trainabilityByBand: { novice: 1.0, intermediate: 0.95, advanced: 0.9, highlyAdvanced: 0.85 },
    prerequisites: [], evidence: 'seed',
  ...
  { id: 'mobility', family: 'tissue', adaptations: ['sarcomerogenesis', 'tissue_tolerance'],
    ...
    recoveryTimeH: 24, trainabilityByBand: { novice: 1.0, intermediate: 1.0, advanced: 0.95, highlyAdvanced: 0.95 },
    prerequisites: [], evidence: 'seed',
  ...
  { id: 'stability', family: 'control', adaptations: ['proprioception', 'co_contraction'],
    ...
    recoveryTimeH: 24, trainabilityByBand: { novice: 1.0, intermediate: 0.95, advanced: 0.9, highlyAdvanced: 0.9 },
    prerequisites: [], evidence: 'seed',
  ...
  { id: 'robustness', family: 'durability', adaptations: ['tendon_remodelling', 'tissue_tolerance', 'bone_density'],
    ...
    recoveryTimeH: 72, trainabilityByBand: { novice: 1.0, intermediate: 1.0, advanced: 0.95, highlyAdvanced: 0.9 },
    prerequisites: [], evidence: 'seed',
