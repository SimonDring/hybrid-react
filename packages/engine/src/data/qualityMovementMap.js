...
export const QUALITY_MOVEMENT = {
  maxStrength:       { movementPatterns: ['squat', 'hinge', 'hpush', 'vpush', 'hpull', 'vpull', 'olympic'], forceVelocity: 'maximal-force', contraction: 'grinding', evidence: ev('moderate') }, // +olympic (WP-49): the classic lifts build max strength too; discipline-gated so byte-identical for non-olympic profiles
  ...
  explosiveStrength: { movementPatterns: ['squat', 'hinge', 'lunge', 'olympic'], forceVelocity: 'strength-speed', contraction: 'explosive-concentric', evidence: ev('moderate') }, // +lunge (H9 C9): unilateral explosive drivers (bounding, sled) are lunge-pattern; +olympic (WP-49): snatch/C&J are the premier explosive-strength drivers — discipline-gated, byte-identical for non-olympic profiles
