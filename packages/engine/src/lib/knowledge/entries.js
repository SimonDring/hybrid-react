...
export const ENTRIES = [
  ...
  },
  {
    ...
    rule: 'Programmed warm-up ramp to near-maximal work (07-PROGRESSION §2.2; closes SR-10): a heavy top set is reached through programmed ascent sets inside the session, never cold off an activation-only primer. Ascending %-of-top-set ramp sets precede the working top set of every loadable primary compound.',
    value: { steps: [{ pct: 0.4, reps: 5 }, { pct: 0.6, reps: 3 }, { pct: 0.8, reps: 2 }] },
    evidenceLevel: 'L5',
    source: 'Standard S&C warm-up ramping to a working top set (Rippetoe warm-up sets; general strength practice) — an injury-risk/quality gap the pin shipped (SR-10); ramp shape is conventional practice',
    confidence: 'low',
    lastReviewed: '2026-07-15',
    appliesTo: ['progression', 'allocator', 'dose']
  },
